...
public class MyStringUtils {
	...
	/**
	 * Dado un string devulve las palabras que forman dicho string.
	 * @param line string a separar en palabras, not null
	 * @return Un array de strings con las palabras que tiene el string original.
	 */
