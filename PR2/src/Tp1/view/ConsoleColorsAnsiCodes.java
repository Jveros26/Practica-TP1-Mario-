...
public class ConsoleColorsAnsiCodes {
    
    public static final String ANSI_RGB   = "\u001B[38;2;%s;%s;%sm";
    public static final String ANSI_BLACK = "\u001B[30m";
    public static final String ANSI_RED = "\u001B[31m";
    public static final String ANSI_LRED = ANSI_RGB.formatted(209,89,81);
    ...
    public static final String ANSI_LRED_BACKGROUND = 
    							ANSI_RGB_BACKGROUND.formatted(255, 91, 97);
